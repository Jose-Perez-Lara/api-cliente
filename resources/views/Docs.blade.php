        ...
        <section>
            ...
            <ul class="space-y-4">
                <li class="bg-white p-4 rounded-md shadow-md">
                    ...
                    <code class="bg-gray-100 text-sm p-2 rounded-md">https://localhost:8000/api/v1/usuarios</code>
                    <h4 class="mt-2 font-semibold">Ejemplo de Petición:</h4>
                    <pre class="bg-gray-100 text-sm p-2 rounded-md">
GET https://localhost:8000/api/v1/usuarios</pre>
                </li>
                <li class="bg-white p-4 rounded-md shadow-md">
...
Body:'{"nombre": "Juan Perez", "email": "juan@example.com", "edad": 30}'</pre>
                ...
                <li class="bg-white p-4 rounded-md shadow-md">
                    ...
                    <code class="bg-gray-100 text-sm p-2 rounded-md">https://localhost:8000/api/v1/usuarios/{id}</code>
                    <h4 class="mt-2 font-semibold">Ejemplo de Petición:</h4>
                    <pre class="bg-gray-100 text-sm p-2 rounded-md">
GET https://localhost:8000/api/v1/usuarios/1 </pre>
                </li>
                <li class="bg-white p-4 rounded-md shadow-md">
...
Body:'{"edad": 14}'</pre>
                ...
                <li class="bg-white p-4 rounded-md shadow-md">
                    ...
                    <h4 class="mt-2 font-semibold">Ejemplo de Petición:</h4>
                    <pre class="bg-gray-100 text-sm p-2 rounded-md">
DELETE https://localhost:8000/api/v1/usuarios/1</pre>
                </li>
            </ul>
        </section>
    </main>
